...
const SendNotificationContainer = (): JSX.Element => {
  ...
  const downloadExcel = async (
    ...
    if(notification===true){
      ...
      try {
        ...
        const fetchData=await axios.post(API_KIWI+'alerts-admin/notifications', o)
  
        // const fetchData = await axios.get(API_URI);
        // setBusiness(fetchData.data.data);
...
export { SendNotificationContainer };
export type { SendNotificationViewProps };
